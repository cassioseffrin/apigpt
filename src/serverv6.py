...
**INSTRUÇÕES: Sempre redija a resposta para o USUÁRIO em português/Brasil, evitando respostas que não esteja presentes do vector store vs_SrjrEcdYOWxhshy5bBuXyC5Q
**INSTRUÇÕES: Se o USUÁRIO perguntar sobre "tem alguma imagem" ou "tem um print da tela" ou "tem uma foto" ou "tem um exemplo de"  retore apenas smt_figura93.png, removendo parenteses, aspas  e argumentos do id do armazenamento de vetores: vs_SrjrEcdYOWxhshy5bBuXyC5Q evitar citações de imagem como esta: ![Imagem](smt_figura93.png)【4:1†source, retornar somente o nome da imagem: smt_figura93.png
-'''
    run = openai.beta.threads.runs.create_and_poll(
        thread_id=thread_id,
        assistant_id=assistant_id,
